...
const Test = () => {
  return (
    <div className="relative min-h-screen bg-primary to-gray-900 flex flex-col items-center justify-center">
      ...
      <h1 className="text-white text-3xl font-bold mb-8">Join as a student or teacher</h1>
      <div className="flex space-x-8">

            {/* student card */}
            <Link to={'/user/register'} className="relative bg-[#524870] text-white p-6 rounded-lg shadow-lg w-60 h-60 hover:border-2 hover:border-white  hover:bg-primary-700 hover:opacity-80 hover:shadow-2xl hover:cursor-pointer transition duration-300 ease-in-out">
            ...
            {/* teacher card */}
            <Link to={'/teacher/register'} className="relative bg-[#524870] text-white p-6 rounded-lg shadow-lg w-60 h-60 hover:border-2 hover:border-white hover:bg-primary-700 hover:opacity-80 hover:shadow-2xl hover:cursor-pointer transition duration-300 ease-in-out">
                <div className="absolute top-2 left-2 bg-white text-[#524870] p-2 rounded-full">
