            ...
            <div className="p-8">
                ...
                <div className="flex gap-4 mb-4">
                    ...
                    <select
                        ...
                        onChange={handleInputChange}
                        className="mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm"
                    >
