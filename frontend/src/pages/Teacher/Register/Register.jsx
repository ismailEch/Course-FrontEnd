...
import loginPic from '../../../assets/register3.png';
...
function Register() {
    ...
    return (
        <div className='' style={{ backgroundColor: '#2C1F4A' }}>
            <div className="py-16 bg-white mb-[-42px]">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mt-2">
                                ...
                                <input
                                    ...
                                    className="text-gray-900 focus:outline-none  focus:shadow-outline border border-gray-300 py-2 px-4 block w-full appearance-none placeholder-gray-200 rounded-xl"
                                    type="text"
                                    name="firstName"
                                    value={firstName}
